...
if (isset($_GET['id'])) {
    $tush = selectOne('tushaal', ['id' => $_GET['id']]);
}
$other_tush = selectAll('tushaal' . " ORDER BY id DESC LIMIT 10");
// display($other_tush)
$page = 'transparency';
?>
...
<body>
    ...
    <section id="dynamic-tushaal">
        <div class="container">
            <div class="subcontainer">            
                <div class="tushaal-one">       
                    <span class="title">Газрын даргын <span><?php echo $tush['number']; ?></span>-р тушаал</span>
                    <br><h3><?php echo $tush['title']; ?></h3>
                    <span class="date"><?php echo $tush['date']; ?></span><br>
                    <div class="pdf-wrapper">
                        <iframe id="pdf" src="<?php echo $tush['pdf']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe> 
                    </div>                
                </div>
                <hr>
                <div class="other-tushaal">
                    <?php foreach($other_tush as $tush): ?>
                        <a href="tushaal-one?id=<?php echo $tush['id']; ?>">
                            <div class="other-card">
                                <div class="other-post-content">
                                    <h3 class="op-title2" ><?php echo $tush['title']; ?></h3>
                                    <p>Газрын даргын <span><?php echo $tush['number']; ?></span>-р тушаал</p>
                                </div>
                            </div>
                        </a>
                    <?php endforeach; ?> 
