                    ...
                    <li>
                        ...
                        <ul class="sub">
                            <li>
                                ...
                                <ul class="sub2">
                                    <li><a href="https://e-mongolia.mn/service/barilga-baiguulamjiig-ashiglaltad-oruulakh-khuselt-khuleen-avakh--(niislel-aimag)">Цахимаар хүсэлт гаргах</a></li>
                            ...
                            <li><a href="https://e-mongolia.mn/home">Emongolia</a></li>
    ...
    <section id="poll">
        <div class="container">
            <div class="subcontainer">            
                <div class="intro">
                    <h3>Хотын стандартыг батлуулах, хэрэгжилтийг зохион байгуулах журам </h3>
                    <span>2023-08-30</span>
                    <p>Энэхүү журмын зорилго нь нийслэлийн нутаг дэвсгэрт иргэдийн эрүүл, аюулгүй, ая тухтай амьдрах орчныг бүрдүүлэхэд чиглэсэн хотын стандартыг боловсруулах, батлуулах, хэрэгжүүлэх, хотын стандартын тогтолцоог хөгжүүлэх, түүнд хамаарах үйл ажиллагааг зохицуулахад оршино. 
                        <br> Тус журмын төсөлтэй танилцаж, саналаа өгч хамтран ажиллана уу. Баярлалаа.  
                    </p>
                    <div class="link">
                        <a href="https://forms.gle/g8NYtMrRmqaU9zbY9">Санал өгөх</a>
                    </div>
                </div>
                <div class="content">
                    <div class="poll-pdf">       
                        <div class="pdf-wrapper">
                            <iframe id="pdf" src="include/poll/juram_tusul.pdf#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe> 
                        </div>                
                    </div>
                    <hr>
                    <div class="form">
                        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScwCDfNMwbEjBEDkU71iPfiPL4q9jBsBaYgUOm9vHocMkaFnA/viewform?embedded=true" width="400" height="1000" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
                    </div>
                </div>
            </div>
        </div>
