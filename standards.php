...
$standards = selectAll('standards' . " ORDER BY id");
$page = 'standards';
?>
                    ...
                    <table id="mytable">
                        <tbody>
                            <?php foreach($standards as $standard): ?>
                                <tr>
                                    <td><span><?php echo $standard['code']; ?></span><?php echo $standard['name']; ?></td>
                                    <td><a href="standard-one?id=<?php echo $standard['id']; ?>">үзэх <i class="fa-solid fa-arrow-right-long"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
        ...
        <div class="container">
            <div class="subcontainer">
                ...
                <div class="footer-content">
                    ...
                    <div class="footer-item">
                        <h2>Хаяг</h2>
                        <p>Улаанбаатар Хотын Захиргааны төв цогцолбор, <br> Наадамчдын зам-1201, Хан-Уул</p>
                    </div>
                </div>
            </div>
        </div>
