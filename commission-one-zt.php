...
if (isset($_GET['id'])) {
    $commission = selectOne('commission_zt_22', ['id' => $_GET['id']]);
};
            ...
            <div class="subcontainer">            
                <div class="commission-wrapper">
                    ...
                    <div class="commission-pdf">        
                        <iframe id="pdf" src="include/commission22_zt/<?php echo $commission['file_path']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe>
                    </div>           
                </div>
            </div>
        </div>
