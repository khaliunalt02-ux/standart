...
$juram = selectAll('juram' . " ORDER BY id DESC");
$laws = selectAll('law' . " ORDER BY id");
// $shiidver = selectAll('shiidver' . " ORDER BY id DESC");
...
<body>
    ...
    <section id="duremjuram">
        <div class="container">
            <div class="filter-container">
                <div class="filter-item law" data-filter="law-filter"><span>Хууль, тогтоомж</span></div>
                <div class="filter-item juram" data-filter="juram-filter"><span>Дүрэм, журам</span></div>
            ...
            <div class="subcontainer">            
                <div id="juram">
                    <table id="mytable">
                        <tbody>
                            <?php foreach($juram as $j): ?>
                                <tr>
                                    <td><?php echo $j['title']; ?></td>
                                    <td><a href="legal-one?id=<?php echo $j['id']; ?>">үзэх <i class="fa-solid fa-arrow-right-long"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>          
                        ...
                        <tbody>
                            <?php foreach($laws as $law): ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo $law['link']; ?>">үзэх <i class="fa-solid fa-arrow-right-long"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>                  
