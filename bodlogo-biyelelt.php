...
$bodlogo = selectAll('bodlogo' . " ORDER BY id");
...
<body>
    ...
    <section id="bodlogo">
        <div class="container">
            <div class="subcontainer">            
                <div class="bodlogo-wrapper">
                    <table id="mytable_bodlogo">
                        <tbody>
                            <?php foreach($bodlogo as $b): ?>
                                <tr>
                                    <td><?php echo $b['name']; ?></td>
                                    <td><a href="bodlogo-biyelelt-one?id=<?php echo $b['id']; ?>">үзэх <i class="fa-solid fa-arrow-right-long"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>              
    ...
    <script src="assets/bodlogo.js"></script>
