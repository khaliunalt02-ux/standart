...
<head>
    ...
    <link rel="icon" type="image/png" sizes="50x50" href="images/favicon-96x96.png">
            ...
            <div class="subcontainer">
                ...
                <div class="post">
                    <?php foreach($posts as $post): ?>
                        <div class="post-box">
                            <img src="include/post_images/<?php echo $post['attach_path']; ?>" alt="" class="post-img">
                            <span><?php echo substr($post['date'],0,10); ?></span>
                            <a href="post-page?id=<?php echo $post['id']; ?>" class="post-title">
