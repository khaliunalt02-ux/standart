...
if (isset($_GET['id'])) {
    $shiid = selectOne('shiidver', ['id' => $_GET['id']]);
}
$other_shiid = selectAll('shiidver' . " ORDER BY id DESC LIMIT 10");
        ...
        <div class="container">
            <div class="subcontainer">            
                <div class="tushaal-one">       
                    <span class="title"><?php echo $shiid['type']; ?></span>
                    <h3><?php echo $shiid['title']; ?></h3>
                    <span class="date"><?php echo $shiid['date']; ?></span><br>
                    <div class="pdf-wrapper">
                        <iframe id="pdf" src="include/shiidver/<?php echo $shiid['pdf']; ?>#view=FitH&navpanes=0&toolbar=0" frameborder="0"></iframe> 
                    </div>                
                </div>
                <hr>
                <div class="other-tushaal">
                    <?php foreach($other_shiid as $shiid): ?>
                        <a href="shiidver-one?id=<?php echo $shiid['id']; ?>">
                            <div class="other-card">
                                <div class="other-post-content">
                                    <h3 class="op-title2" ><?php echo $shiid['title']; ?></h3>
                                    <p><?php echo $shiid['type']; ?></p>
                                </div>
                            </div>
                        </a>
                    <?php endforeach; ?> 
