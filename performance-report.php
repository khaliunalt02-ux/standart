...
$performances = selectAll('performance');
$page = 'standards';
?>
                    ...
                    <table id="mytable_projects">
                        <tbody>
                            <?php foreach($performances as $performance): ?>
                                <tr>
                                    <td><span><?php echo $performance['code']; ?></span><?php echo $performance['name']; ?></td>
                                    <td><a href="performance-one-pr?id=<?php echo $performance['id']; ?>">үзэх <i class="fa-solid fa-arrow-right-long"></i></a></td>
